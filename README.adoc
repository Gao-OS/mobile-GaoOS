...
*Mobile GaoOS* is a superset on top of link:https://nixos.org/nixos/[NixOS Linux],
...
ifdef::env-github[]
Read more: <<doc/about.adoc#,About Mobile GaoOS>>.
endif::[]
ifndef::env-github[]
Read more: <<about.adoc#,About Mobile GaoOS>>.
endif::[]

ifdef::env-github[]
⚠️ **Note**: Mobile GaoOS is only expected to build successfully against the **unstable** branch of Nixpkgs.
endif::[]

== Documentation

 * link:https://Gao-OS.github.io/Mobile-GaoOS/[The Mobile GaoOS website] hosts the rendered link:https://github.com/Gao-OS/Mobile-GaoOS/tree/development/doc[doc folder] for Mobile GaoOS documentation.

As Mobile GaoOS is a superset of NixOS Linux, the following documentation applies:
...
Mobile GaoOS development and questions is done within the link:https://github.com/Gao-OS/Mobile-GaoOS[Mobile GaoOS GitHub repository].
...
ifdef::env-github[]
 * <<CONTRIBUTING.adoc#,Contributing to Mobile GaoOS>>
endif::[]
ifndef::env-github[]
 * <<contributing.adoc#,Contributing to Mobile GaoOS>>
endif::[]
...
Mobile GaoOS is licensed under the link:https://github.com/Gao-OS/Mobile-GaoOS/blob/development/LICENSE[MIT License].
