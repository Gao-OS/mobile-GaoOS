...
class Configuration::NixOSConfiguration
  ...
  def imports_fragment()
    imports = [
      "(import <mobile-gaoos/lib/configuration.nix> { device = #{Configuration::Device.identifier.to_json}; })",
    ...
    when :plamo
      imports << "<mobile-gaoos/examples/plasma-mobile/plasma-mobile.nix>"
    end
...
<<EOF
# NOTE: this file was generated by the Mobile GaoOS installer.
{ config, lib, pkgs, ... }:
