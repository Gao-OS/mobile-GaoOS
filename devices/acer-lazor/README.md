...
For more details the [Firmware Menu Interface](https://chromium.googlesource.com/chromiumos/docs/+/HEAD/debug_buttons.md#Firmware-Menu-Interface) section from the upstream documentation can be read.

You will need to:

1. Boot in *Recovery mode* by resetting pressing `Esc` + `Refresh (F3)` + `Power`
