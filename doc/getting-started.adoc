...
The project is hosted under the link:https://github.com/mobile-gaoos/[Mobile GaoOS organization],
as link:https://github.com/Gao-OS/Mobile-GaoOS[mobile-gaoos].
...
```
$ git clone git@github.com:mobile-gaoos/mobile-gaoos.git
```
